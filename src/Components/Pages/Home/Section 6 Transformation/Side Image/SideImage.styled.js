...
export const ImageDiv = styled.div`
  ...
  & .first {
    position: absolute;
    border-top: 2.6667px solid rgb(165, 250, 0);
    border-left: 2.6667px solid rgb(165, 250, 0);
    top: 0;
    left: 0;
  ...
  & .second {
    position: absolute;
    border-top: 2.6667px solid rgb(165, 250, 0);
    border-right: 2.6667px solid rgb(165, 250, 0);
    top: 0;
    right: 0;
    height: clamp(2.5rem, 1.6959951456rem + 3.430420712vw, 5.8125rem);
    width: clamp(2.5rem, 1.6959951456rem + 3.430420712vw, 5.8125rem);
  ...
  & .third {
    position: absolute;
    border-bottom: 2.6667px solid rgb(165, 250, 0);
    border-left: 2.6667px solid rgb(165, 250, 0);
    bottom: 0;
    left: 0;
    height: clamp(2.5rem, 1.6959951456rem + 3.430420712vw, 5.8125rem);
